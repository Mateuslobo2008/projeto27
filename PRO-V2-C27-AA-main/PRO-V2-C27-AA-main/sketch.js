...
function preload() {
  ...
  json = loadJSON("assets/boat/brokenBoat.JSON");
  spriteSheet = loadImage("assets/boat/brokenBoat.png");
}
...
function setup() {
  ...
  var brokenBoatFrames = json.frames;
  for(var i = 0; i < brokenBoatFrames.length; i++) {
    var pos = brokenBoatFrames[i].position;
    var img = spriteSheet.get(pos.x,pos.y, pos.w,pos.h);
    animacaodonavioquebrado.push(img);
  }
